...
$(function(e){
    ...
    if(localStorage.getItem('menu_bar')){
        window.data['menu_bar'] = localStorage.getItem('menu_bar');
    }else{
        window.data['menu_bar'] = 'true';
    }
...
setTimeout(function(){
    ...
    iframeEl.contentWindow.postMessage(['test','ok'],'*');
    setTimeout(function(){
                ...
                Object.keys(new_ob).forEach(key => {
                    if(new_ob[key] != ''){
                        ...
                        if(key == 'contrast'){
                            ...
                            localStorage.setItem('menu_bar', new_ob[key]);

                            if(new_ob[key] == 'true'){
                                $('#hkoAccessibilityAssets').attr('style','');
                                if(new_ob['layout'] != 'default'){
                                    $('#hkoAccessibilityAssets').css({'height':'350px','min-height':'350px','width':'100%'});
                                }else{
                                ...
                                if(new_ob['layout'] != 'default'){
                                    ...
                                    }else if(new_ob['position'] == 'middle-right'){
                                        $('#hkoAccessibilityAssets').css({'width':'50px','right':'15px','top':'50%'});
                                    }else if(new_ob['position'] == 'bottom-left'){
                                        $('#hkoAccessibilityAssets').css({'width':'50px','left':'15px','bottom':'15px'});
                                    }else if(new_ob['position'] == 'bottom-right'){
                                        $('#hkoAccessibilityAssets').css({'width':'50px','right':'15px','bottom':'15px'});
                                    }else if(new_ob['position'] == 'bottom-middle'){
                                        $('#hkoAccessibilityAssets').css({'width':'50px','right':'50%','bottom':'15px'});
                                    }
                                }else{
                                    $('#hkoAccessibilityAssets').css({'height':'350px','width':'100%'});
                                }
                            }
                            window.data[key] =new_ob[key];
                        ...
                        $('.skip-link').addClass('visually-hidden');
                        window.data[key] = '';
                    }
                });
                Object.keys(window.data).forEach(key => {
                    if(window.data[key] != ''){
                        if(key == 'line_height' || key == 'font_size' || key == 'font_spacing' && window.data[key] != ''){
                            var style = '<style id="readtext">  body{';
                        ...
                        if(key == 'screen_cursor'){
                            $('body').removeClass('screen_cursor-white');
                            $('body').removeClass('screen_cursor-blank');
                        }
                        if(key == 'skip_links'){
