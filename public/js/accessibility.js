                ...
                Object.keys(new_ob).forEach(key => {
                    if(new_ob[key] != ''){
                        ...
                        if(key == 'contrast'){
                            ...
                            text_mode_on();
                            window.data[key] =new_ob[key];
                        }else if(key == "skip_links"){
                            $('.skip-link').removeClass('visually-hidden');
                        } else{
                            window.data[key] =new_ob[key];
                        }
                    }else{
