        ...
        <form method="post" action="admin/settings" class="form-settings">
            ...
            <div class="menu-bar hidden contrast" id="tabs-{{$key}}">
                <div class="contrast-content">
                    ...
                    <div class="contrast-items <?php if($settings->contrast == 'contrast-'.$color_items->id.''):?> active-checkbox <?php endif?>" data-index="<?= $key?>" data-id="{{$color_items->id}}">
                        <i class="far fa-times-circle"></i>
                        <input type="radio" name="contrast" value="default"  <?php if($settings->contrast == 'contrast-'.$color_items->id.''):?> checked <?php endif?> />
                    </div>
                    <?php else: ?>
                    <div class="contrast-items <?php if($settings->contrast == 'contrast-'.$color_items->id.''):?> active-checkbox <?php endif?>" data-index="<?= $key?>" style="background: {{$color_items->background}};color:{{$color_items->color}}" data-id="{{$color_items->id}}" >
                        A
                        <input type="radio" name="contrast" value="contrast-{{$color_items->id}}" <?php if($settings->contrast == 'contrast-'.$color_items->id.''):?> checked <?php endif?>/>
                    </div>
                    <?php endif; ?>
